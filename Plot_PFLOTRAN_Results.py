...
# Special_Mineral = "Calcite"
# Special_Mineral = "Hematite"
Special_Mineral = "Goethite"
...
ax.set_xlabel(df1.columns[0], fontsize=16)
ax.set_ylabel('Amount [mol]', fontsize=16)
ax.tick_params(axis='x', labelsize=15)
ax.tick_params(axis='y', labelsize=15)
ax.legend(loc=(0.7, 0.5), fontsize=13)
ax.grid(True)

ax_inset = inset_axes(ax, width='30%', height='30%', loc=3, bbox_to_anchor=(0.6, 0.05, 0.9, 0.9),
...
ax_inset2 = inset_axes(ax, width='30%', height='30%', loc=3, bbox_to_anchor=(0.25, 0.05, 0.9, 0.9),
                       bbox_transform=ax.transAxes)
...
minerals = ["Pyrite", Special_Mineral, "Pyrrhotite"]
...
for mineral in minerals:
    ...
    ax2.set_xlabel(df1.columns[0], fontsize=16)
    ax2.set_ylabel('Amount Change [mol]', fontsize=16)
