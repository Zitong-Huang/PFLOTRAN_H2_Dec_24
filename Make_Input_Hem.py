...
# df = pd.read_excel("./Parameters_Base.xlsx", engine='openpyxl')
...
np.savetxt('Hem_vol.txt', Hem_vol, fmt='%f')
...
#       Goethite              1.0d-16  {10**L_SA} m^2/g
#       Anhydrite             1.0d-16  {10**L_SA} m^2/g
#       Pyrrhotite            1.0d-7   {10**L_SA} m^2/g
#       Hematite              {H_v}    {10**L_SA} m^2/g
#       Magnetite             1.0d-7   {10**L_SA} m^2/g
#    /
# END
#
# CONSTRAINT inlet
