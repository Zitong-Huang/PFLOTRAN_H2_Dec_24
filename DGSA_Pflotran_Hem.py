...
ax.legend()
plt.savefig('H2S_Cluster_Hem.png', dpi=300)
plt.show()
...
ax.text(-0.2, 1.1, 'c)', transform=ax.transAxes, fontsize=20, fontweight='bold', va='top')
...
# ax.set_xlabel('Interaction Sensitivity for Total H$_2$ Loss', fontsize=13)
ax.set_xlabel('Interaction Sensitivity for H$_2$S Formation', fontsize=13)

ax.tick_params(axis='both', which='major', labelsize=13)
ax.text(-0.2, 1.1, 'a)', transform=ax.transAxes, fontsize=20, fontweight='bold', va='top')
