...
dfexp = pd.read_excel(os.path.join(folder_path, 'LHS_Parameters_Hem_Rate.xlsx'))
# titles = ['Temperature', 'Water saturation', 'Fe(III)/Fe(II) ratio', 'Weight percent of iron', 'Specific surface area', 'Pyrite dissolution rate', 'Hematite dissolution rate', 'Goethite dissolution rate']
titles = ['Temperature', 'Water saturation', 'Fe(III)/Fe(II) ratio', 'Pyrite Mass', 'Hematite Mass', 'Pyrite rate coefficient', 'Hematite rate coefficient']
...
# reduced_dim_tsne = tsne.fit_transform(scaled_T)
#
...
# plt.savefig('./Cluster_H2tot_Hem.png', dpi=300)
# # plt.savefig('./Cluster_H2S_Hem.png', dpi=300)
# plt.show()
...
# ax.set_xlabel('Sensitivity for H$_2$ Loss from Geochemical Reaction')
# ax.set_xlabel('Sensitivity for Total H$_2$ Loss')
ax.set_xlabel('Sensitivity for H$_2$S Generation')

# fig.savefig('./H2_Tot_Hem.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
# fig.savefig('./H2_Dis_Hem.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
# fig.savefig('./H2_Rea_Hem.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
fig.savefig('./H2S_Hem.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
...
#=========================
# Only show interactions with sensitivity >= 1 and the next 10 most
...
# fig.savefig('./H2_Tot_Interact_Hem.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
# fig.savefig('./H2_Dis_Interact_Hem.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
# fig.savefig('./H2_Rea_Interact_Hem.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
fig.savefig('./H2S_Interact_Hem.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
